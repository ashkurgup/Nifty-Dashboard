    ...
    for t in trades:
        ...
        if t.get('status') == "ACTIVE":
            ...
            if elapsed >= 90 and last_alert == 0:
                ...
                r.set(f"psych_dur:{t['id']}", 90, ex=86400)
                ...
                r.set(f"psych_dur:{t['id']}", elapsed, ex=86400)
...
def _process_pnl_milestones(pnl):
    ...
    if pnl <= -2200 and not r.get("lock_loss_2200"):
        ...
        r.set("lock_loss_2200", "1", ex=43200)
    ...
    # Profit Milestones
        ...
        r.set("lock_win_8000", "1", ex=43200)
        ...
        r.set("lock_win_6500", "1", ex=43200)
        ...
        r.set("lock_win_4500", "1", ex=43200)
